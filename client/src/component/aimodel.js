    ...
    render(){
        return(
            ...
            <div id="dataset" className="dataset__ai">
                ...
                <p>The original food-101 dataset can be obtained on the following link: <a href="https://data.vision.ee.ethz.ch/cvl/datasets_extra/food-101/" target="_blank" rel="noopener noreferrer"><u> https://data.vision.ee.ethz.ch/cvl/datasets_extra/food-101/ </u> </a></p>
            ...
            <div id="results" className="result__ai">
                ...
                <a href = "https://colab.research.google.com/drive/1qsglV5DVrwAkz-RhbTJ8ggkCb3K_tpjM?usp=sharing" target="_blank" rel="noopener noreferrer"> <p><u>Check out the code</u></p> </a>
                </div>
                </div>
            </div>
            </div>
